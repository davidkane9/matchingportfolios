...
comparison of headache rates is made across matched units, where the
...
holdings to similar non-holdings provides a more precise estimate of the
treatment effect.
...
represent a concrete counterfactual. Yet they do not share the
...
the same as that of an equal-weighted portfolio spanning the entire universe.
